...
export const SPECIALS = [
  ...
  {
    title: 'Matcha Latte',
    sub: 'Stone-ground oat milk matcha \u2014 your new morning ritual.',
    cta: 'Order now',
    accent: '#76E0A8',
    img: 'https://images.unsplash.com/photo-1515823064-d6e0c04616a7?w=600&q=70&auto=format&fit=crop',
  },
  {
    title: 'Burger Special',
    sub: 'Classic beef patty with our secret sauce. GH\u20B560.',
    cta: 'Try it',
    accent: '#FFA94C',
